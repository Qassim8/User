                ...
                <div id="services" className="hall-info py-5" dir="rtl">
                    <div className="">
                        ...
                        <div className="info mb-0">
                            ...
                            <p className="">مارينا هي صالة تقع في الخرطوم داخل حدائق الطائف تتيح الصالة خدمات رائعة للزبائن مع وجود تخفيضات في حالة الحجز لاكثر من دورة تحتوي الصالة على مساحة تسع لاكثر من 700 شخص ومع خدمة توزيع طعام مثالية تكون من افضل الصالات في الخرطوم بحري</p>
                        </div>
                    </div>
                </div>
